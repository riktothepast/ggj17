...
using Prime31.ZestKit;
    ...
    public class VectorShakeTween : AbstractTweenable
    {
        private Vector3 _transformPosition;
        private Vector3 _shakeDirection = Vector3.zero;
        public Vector3 _shakeOffset = Vector3.zero;
        ...
        public VectorShakeTween(Vector3 trans, float shakeIntensity = 0.3f, float shakeDegredation = 0.95f, Vector3 shakeDirection = default( Vector3 ))
        {
            _transformPosition = trans;
        ...
        public override bool tick()
        {
            ...
            if (Mathf.Abs(_shakeIntensity) > 0f)
            {
                ...
                _transformPosition += _shakeOffset;
